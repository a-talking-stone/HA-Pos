...
class Darknet(nn.Module):
    ...
    def __init__(self, config_path='/home/fhr/HAPos/model/yolov3_rs.cfg', img_size=1024, obj_out=False):
...
if __name__ == "__main__":
    ...
    model = Darknet()
    model.load_weights('/home/fhr/HAPos/saved_models/yolov3.weights')
    # model.eval()
