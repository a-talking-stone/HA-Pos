...
2. Secondly, download the pretrained Yolov3 model and place it in the 'saved_models' directory, i.e., ['./saved_models/yolov3.weights'](https://pan.baidu.com/s/1As2Z0e8hD2PLimplLdsReg)(code: iu7g).
